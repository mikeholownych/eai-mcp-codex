...
workflow_orchestrator_settings = WorkflowOrchestratorSettings(
    _env_prefix="WORKFLOW_ORCHESTRATOR_"
)
verification_feedback_settings = VerificationFeedbackSettings(
    _env_prefix="VERIFICATION_FEEDBACK_"
)
...
collaboration_orchestrator_settings = CollaborationOrchestratorSettings(
    _env_prefix="COLLABORATION_ORCHESTRATOR_"
)
