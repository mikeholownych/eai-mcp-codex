...
def check_disk_usage(path: str = "/", max_usage_percent: float = 80.0) -> Dict[str, Any]:
...
def get_health_checker(service_name: str = "default") -> HealthChecker:
    ...
    if _health_checker is None:
        ...
        _health_checker.register_check("memory", lambda: check_memory_usage(), critical=False)
        _health_checker.register_check("disk", lambda: check_disk_usage(), critical=False)
