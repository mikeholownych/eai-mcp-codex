...
class EnhancedModelRouter:
    ...
    def _determine_routing_strategy(self, request: ModelRequest) -> str:
        ...
        critical_keywords = [
            'security', 'critical', 'production', 'compliance', 'audit',
            'financial', 'legal', 'safety', 'regulatory'
        ]
    ...
    async def _route_with_ensemble(self, request: ModelRequest) -> ModelResponse:
        ...
        logger.info(f"Using ensemble routing for critical request: {request.request_id}")
    ...
    async def get_routing_stats(self) -> Dict[str, Any]:
        ...
        return {
            'ensemble_router': {
                'performance_data': len(self.ensemble_router.performance_tracker.performance_history),
                'models_tracked': list(self.ensemble_router.performance_tracker.performance_history.keys())
            },
            'adaptive_router': {
                'performance_data': len(self.adaptive_router.performance_tracker.performance_history),
