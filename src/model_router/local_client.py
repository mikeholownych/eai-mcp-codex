...
class LocalLLMClient:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        self.model_configs = {
            ...
            "deepseek-coder": {
                ...
                "cost_per_1k_output": 0.0,
                "use_cases": ["coding", "debugging", "code_review", "programming", "architecture"],
                "provider": "ollama",
            ...
            "codellama": {
                ...
                "cost_per_1k_input": 0.0,
                "cost_per_1k_output": 0.0,
                "use_cases": ["coding", "code_generation", "programming", "code_explanation"],
                "provider": "ollama",
            ...
            "codestral": {
                ...
                "cost_per_1k_input": 0.0,
                "cost_per_1k_output": 0.0,
                "use_cases": ["advanced_coding", "architecture", "complex_programming", "system_design"],
                "provider": "ollama",
    ...
    async def send_message(self, request: LocalRequest) -> LocalResponse:
        ...
        try:
            model_config = self.model_configs.get(request.model, self.model_configs["mistral"])
    ...
    async def _send_to_fastapi(self, request: LocalRequest) -> LocalResponse:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=120.0) as client:
                ...
                if response.status_code != 200:
                    error_msg = f"FastAPI LLM error: {response.status_code} - {response.text}"
                    logger.error(error_msg)
                    raise Exception(error_msg)
    ...
    async def route_and_send(
        ...
        coding_keywords = ["code", "function", "class", "algorithm", "programming", "debug", 
