...
class ApiClient {
  ...
  async getWorktrees(): Promise<
    ApiResponse<
      Array<{ id: string; repository: string; branch: string; name: string }>
    >
  > {
  ...
  async getFeedback(): Promise<
    ApiResponse<
      Array<{ id: string; type: string; title: string; status: string }>
    >
  > {
  ...
  async sendChatMessage(
    ...
    ApiResponse<{ id: string; content: string; role: string; timestamp: Date }>
  > {
  ...
  async getVideo(
    ...
    ApiResponse<{ id: string; title: string; description: string; url: string }>
  > {
