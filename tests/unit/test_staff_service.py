...
class TestStaffDashboard:
    ...
    def test_dashboard_access_admin(
        self, mock_verify, mock_get_user, client, mock_auth
    ):
        ...
        response = client.get(
            "/staff/dashboard", headers={"Authorization": "Bearer mock-token"}
        )
    ...
    def test_system_stats(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/stats", headers={"Authorization": "Bearer mock-token"}
        )
...
class TestUserManagement:
    ...
    def test_list_users(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/users", headers={"Authorization": "Bearer mock-token"}
        )
    ...
    def test_get_user(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/users/1", headers={"Authorization": "Bearer mock-token"}
        )
...
class TestTicketManagement:
    ...
    def test_list_tickets(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/tickets", headers={"Authorization": "Bearer mock-token"}
        )
    ...
    def test_get_ticket(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/tickets/T-2024-001", headers={"Authorization": "Bearer mock-token"}
        )
    ...
    def test_ticket_stats(self, mock_verify, mock_get_user, client, mock_auth):
        ...
        response = client.get(
            "/staff/tickets/stats", headers={"Authorization": "Bearer mock-token"}
        )
