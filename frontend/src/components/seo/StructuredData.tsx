...
export const organizationSchema = {
  ...
  description:
    'Advanced AI agent network for developers. Generate production-ready code with multi-agent collaboration, enterprise security, and seamless DevTool integrations.',
...
export const softwareApplicationSchema = {
  ...
  releaseNotes:
    'Initial release with multi-agent collaboration, OAuth integration, and enterprise security features.',
}
...
export const serviceSchema = {
  ...
  description:
    'Professional AI-powered code generation service with multi-agent collaboration and enterprise security.',
  provider: {
    '@type': 'Organization',
    name: 'Ethical AI Insider',
  },
